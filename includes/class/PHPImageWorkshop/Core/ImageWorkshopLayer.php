...
class ImageWorkshopLayer
{
     ...
     *
     * Set $insertUnderTargetedLayer true if you want to move the sublayer under the other sublayer at the targeted
     * level, or false to insert it on the top of the other sublayer at the targeted level
     *
     * @param integer $layerId
     * @param integer $level
     ...
     * You can specify the position left (in pixels) and the position top (in pixels) of the added image relatives to
     * the layer Otherwise, it will be set at 0 and 0
     *
     ...
     * $position: http://phpimageworkshop.com/doc/22/corners-positions-schema-of-an-image.html
     *
     * $positionX, $positionY, $position can be ignored unless you choose a new width AND a new height AND to conserve
     * proportion.
     */
     ...
     * Be careful: some filters can damage transparent images, use it sparingly ! (A good pratice is to use mergeAll
     * on your layer before applying a filter)
     *
     ...
     */
    public function save ($folder, $imageName, $createFolders = TRUE, $backgroundColor = NULL, $imageQuality = 95)
    {
        if ( ! is_file($folder)) {
